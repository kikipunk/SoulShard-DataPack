...
execute run setblock ~ ~ ~ minecraft:cauldron[level=1]
execute run playsound minecraft:block.beacon.power_select master @a[distance=..50] ~ ~ ~ 1.0 1.7
data merge entity @s {Item:{tag:{Unbreakable:1,tier:1b,souls:0s,soulstealer:1b,display:{Name:"{\"text\":\"§eSoulStealer Sword\"}",Lore:["§7SoulStealer I","§7Souls 0/128"," ","§7When in main hand:","§2 1.6 Attack Speed","§2 7 Attack Damage"]},Enchantments:[{id:"minecraft:unbreaking",lvl:98}],HideFlags:7,AttributeModifiers:[{AttributeName:"generic.attackDamage",Name:"generic.attackDamage",Slot:"mainhand",Amount:6,Operation:0,UUIDMost:76770,UUIDLeast:142385}]}}}
