...
execute run summon minecraft:item ~ ~0.5 ~ {Motion:[0.0,0.5,0.0],Item:{id:"minecraft:emerald",Count:1b,tag:{tier:0b,shard:1b,mobshard:0b,mobtype:0s,display:{Lore:["§r§7Drop this shard into an altar","§r§7with creature souls"],Name:"{\"text\":\"§r§bEmpty Shard\"}"}}}}
