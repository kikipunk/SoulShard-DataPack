tellraw @a {"text":"SoulShard DataPack successfully loaded !! 6Version 1.0!!","color":"dark_aqua","hoverEvent":{"action":"show_text","value":"Click for Credit"},"clickEvent":{"action":"run_command","value":"/function soulshard:credit"}}
