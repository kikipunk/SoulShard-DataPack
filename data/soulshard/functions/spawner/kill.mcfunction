summon minecraft:item ~ ~ ~ {Tags:["exit_spawner"],Item:{id:"minecraft:emerald",Count:1b,tag:{souls:0s,tier:0b,shard:1b,mobshard:1b,mobtype:0s,display:{Name:"{\"text\":\"§r§aUnknown Shard\"}",Lore:["§r§7Tier 0","§r§7Souls 0/128"]},HideFlags:63,Enchantments:[{id:"minecraft:unbreaking",lvl:1}]}}}
