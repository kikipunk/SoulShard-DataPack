...
execute if entity @s[advancements={soulshard:soulshard/mob/a_from_spawner=false},nbt={SelectedItem:{id:"minecraft:golden_sword",tag:{tier:4b,soulstealer:1b}}}] run give @s minecraft:firework_star{mobtype:39s,soul:1b,display:{Name:"{\"text\":\"§7Skeleton Horse Soul\"}",Lore:["§7Loot on creature body"," "]}} 4
